...
public class PrometeoCarController : MonoBehaviour
{
    ...
    {
        var canvasChild = GameObject.Find("Canvas").transform.Find("RightHandController");
        throttleButton = canvasChild.transform.Find("Throttle Button").gameObject;
        reverseButton = canvasChild.transform.Find("Reverse Button").gameObject;
        handbrakeButton = canvasChild.transform.Find("Handbrake Button").gameObject;
        turnRightButton = GameObject.Find("Canvas").transform.Find("Turn Right Button").gameObject;
        turnLeftButton = GameObject.Find("Canvas").transform.Find("Turn Left Button").gameObject;
    }
